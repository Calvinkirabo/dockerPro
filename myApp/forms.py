...
class BookForm(forms.ModelForm):
    class Meta:
        model=models.Book
        fields=['name','isbn','author','publication', 'category']
...
class IssuedBookForm(forms.Form):
    ...
    enrollment2=forms.ModelChoiceField(queryset=models.StudentExtra.objects.all(),empty_label="Name and Student number",to_field_name='enrollment',label='Name and Student number')
